...
# AGI (artificial general intelligence) use
I used deep seek 4 free to make StreamingPrintCallback because I'm so bad making it produce nicely formatted text, and the rest of the code is made with no AI. Docstrings are not considered code in the sentence above.

This readme is generated by claude mythos.
